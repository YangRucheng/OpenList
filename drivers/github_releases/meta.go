...
type Addition struct {
	...
	ConcurrentRequests bool   `json:"concurrent_requests" type:"bool" default:"false" help:"use concurrent requests to fetch releases, may cause rate limit issues if too many requests are made"`
